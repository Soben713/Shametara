...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HelpTask'
        db.create_table(u'helpdesk_helptask', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('helper', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainapp.Helper'])),
            ('helpee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainapp.Helpee'], null=True)),
            ('help_price', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('help_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('longitude', self.gf('django.db.models.fields.FloatField')()),
            ('latitude', self.gf('django.db.models.fields.FloatField')()),
            ('is_from_khadem', self.gf('django.db.models.fields.BooleanField')()),
            ('user_comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['khadem.UserComment'], null=True)),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=1, null=True)),
        ))
        db.send_create_signal(u'helpdesk', ['HelpTask'])


    def backwards(self, orm):
        # Deleting model 'HelpTask'
        db.delete_table(u'helpdesk_helptask')
