...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HelpTask.requesting_company'
        db.add_column(u'helpdesk_helptask', 'requesting_company',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainapp.Company'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HelpTask.requesting_company'
        db.delete_column(u'helpdesk_helptask', 'requesting_company_id')
