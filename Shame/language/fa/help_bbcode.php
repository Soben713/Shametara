...
$help = array(
	...
	array(
		0 => 'BBCode چیست ؟',
		1 => 'BBCode برنامه ای برای HTML است، برای استفاده از این ابزار،مدیر تالا باید BBCode را فعال کرده باشد. BBCode مانند تگ های HTML است با این تفاوت که به جای <> باید از قلاب ([]) استفاده کنید.در پست ها میتوانید BBCode غیر فعال کنید.'
	),
	array(
		0 => '--',
		1 => 'فرمت نوشته'
	...
	array(
		0 => 'نحوه Bold، italic و underline کردن نوشته.',
	...
	array(
		0 => 'نحوه تغییر رنگ و اندازه نوشته',
	...
	array(
		0 => 'آیا میتوانم تگ ها را باهم ترکیب دهم ؟',
		1 => 'بله میتوانید، برای مثال :<br /><br /><strong>[size=200][color=red][b]</strong>به من نگاه کن!<strong>[/b][/color][/size]</strong><br /><br />به صورت <span style="color:red;font-size:200%;"><strong>به من نگاه کن!</strong></span> نمایش داده خواهد شد<br /><br />پیشنهاد میکنیم که در نوشته ها زیاد از این روش استفاده نکنید. به خاطر داشته باشید که استفاده از این تگ ها کاملا به خود نویسنده بستگی دارد،در بستن تگ ها دقت کنید. برای مثال این نادرست است :<br /><br /><strong>[b][u]</strong>این نادرست است<strong>[/b][/u]</strong>'
	),
	array(
		0 => '--',
		1 => 'نقل قول و خروجی متن با عرض ثابت'
	),
	array(
		0 => 'نقل قول نوشته در پاسخ ها',
		1 => 'برای نقل قول دو روش وجود دارد، با مرجع و بدون مرجع.<ul><li>برای نقل قول باید متن نقل قول را در مابین تگ <strong>[quote=&quot;&quot;][/quote]</strong>قرار دهید. این روش نقل قول به شما این امکان را میدهد تا متن نقل قول را به شخصی رجوع دهید. برای مثال اگر بخواهید متنی را که آقای احمدی نوشته است،نقل قول کنید باید اینگونه عمل کنید :<br /><br /><strong>[quote=&quot;MR.mohammadi&quot;]</strong>TEXT<strong>[/quote]</strong><br /><br />این عمل به طور خودکار نام آقای محمدی را قبل از متنی که وی نوشته است اضافه خواهد کرد. به یاد داشته باشید که <strong>باید</strong> علامت&quot;&quot; در اطراف نام قرار دهید، آنها انتخابی نیستند.(در این مثال نام احمدی فقط به منظور ذکر مثال آمده است.)</li><li>در روش دوم نام نویسنده متن ذکر نمیشود. برای اینکار متن را در بین تگ های <strong>[quote][/quote]</strong> قرار دهید. وقتی که پیغام نمایش داده شود،خواهید دید که متن درون جعبه نقل قول قرار گرفته است.</li></ul>'
	),
	array(
		0 => 'نوشته در جعبه کد',
		1 => 'برای قرار دادن نوشته ها در جعبه کد، لازم است نوشته را در بین دو تگ [code][/code] قرار دهید. اگر مایل به قرار دادن کد های php در جعبه کد هستید، برای افزایش توانایی خواندن،آنها را بین دو تگ [code=php][/code] قرار دهید. برای مثال [code=php]echo "code here";'
	),
	array(
		0 => '--',
		1 => 'ایجاد لیست'
	...
	array(
		0 => 'لینک به سایتی دیگر',
		1 => 'phpbb BBCode از چند روش برای لینک دادن پشتیبانی میکند.(Uniform Resource Indicators) که به اختصار URL نامیده میشود<ul><li>اولین روش تگ <strong>[url=][/url]</strong> است، هر چه بعد از = وارد کنید به عنوان آدرس لینک استفاده خواهد شد. برای مثال برای لینک دادن به phpbb.com<br /><br /><strong>[url=http://www.phpbb.com/]</strong>از phpbb بازدید کنید<strong>[/url]</strong> استفاده کنید.<br /><br />این تگ لینک مقابل را تولید خواهد کرد <a href="http://www.phpbb.com/"از phpbb بازدید کنید</a> توجه داشته باشید که این لینک ممکن است در همان صفحه و یا صفحه جدید باز شود که به مرورگری که استفاده میکنید بستگی دارد.</li><li>اگر میخواهید که آدرس لینک مانند نام لینک نمایش داده شود اینگونه عمل کنید :<br /><br /><strong>[url]</strong>http://www.phpbb.com/<strong>[/url]</strong><br /><br />این لینک مقابل را تولید خواهد کرد : <a href="http://www.phpbb.com/">http://www.phpbb.com/</a></li><li>با این وجود phpbb یک ویژگی دیگر به نام <i>Magic Links</i> دارد، این ویژگی تمامی آدرس های اینترنتی را که به درستی وارد شوند به طور خودکار به لینک تبدیل میکند حتی اگر http://. نداشته باشند. برای مثال اگر www.phpbb.com را وارد کنید به <a href="http://www.phpbb.com/">www.phpbb.com</a>تبدیل خواهد شد.</li><li>همان ویژگی برای ایمیل ها نیز وجود دارد، میتوانید آدرس ایمیلی را دقیقا وارد کنید برای مثال اگر این ایمیل را وارد کنید :<br /><br /><strong>[email]</strong>no.one@domain.adr<strong>[/email]</strong><br /><br /> به صورت <a href="mailto:no.one@domain.adr">no.one@domain.adr</a> نمایش داده خواهد شد و یا ایمیل no.one@domain.adr را در پیغامتان وارد کنید و این ایمیل به طور خودکار به لینک ایمیل تبدیل خواهد شد</li></ul>مانند سایر تگ ها BBCode میتوانید تگ لینک را هم با سایر لینک ها ترکیب دهید. <strong>[img][/img]</strong> (مشاهده ورودی جدید), <strong>[b][/b]</strong>،و یا غیره. در درج تگ ها باید دقت لازم را داشته باشید تا با دقت تگ را باز کرده و آن را ببندید.برای مثال :<br /><br /><strong>[url=http://www.google.com/][img]</strong>http://www.google.com/intl/en_ALL/images/logo.gif<strong>[/url][/img]</strong><br /><br /><span style="text-decoration: underline">درست نیست</span> و ممکن است به حذف شدن پستتان بیانجامد پس دقت لازم را خرج دهید.'
	),
	array(
		0 => '--',
		1 => 'نمایش تصاویر در پست'
	),
	array(
		0 => 'اضافه کردن پست به تصویر',
		1 => 'phpbb BBCode شامل تگی است که میتوانید به وسیله آن به پستتان تصویر بیافزایید. در هنگام استفاده از این تگ باید دو نکته مهم را رعایت کنید : کاربران مابل لیستند تا در یک پست تصاویر زیادی را ببینند و ثانیا تصاویر انتخاب شده باید بر روی اینترنت و سروری باشند نه در کامپیوتر شخصی شما. برای نمایش تصویر باید لینک تصویر را بین دو تگ <strong>[img][/img]</strong> قرار دهید. برای مثال :<br /><br /><strong>[img]</strong>http://www.google.com/intl/en_ALL/images/logo.gif<strong>[/img]</strong><br /><br />همان گونه که در نکات بالا ذکر کردیم، میتوانید این تگ را با تگ های دیگر ترکیب دهید،برای مثال : <strong>[url][/url]</strong> tag if you wish, e.g.<br /><br /><strong>[url=http://www.google.com/][img]</strong>http://www.google.com/intl/en_ALL/images/logo.gif<strong>[/img][/url]</strong><br /><br />به صورت :<br /><br /><a href="http://www.google.com/"><img src="http://www.google.com/intl/en_ALL/images/logo.gif" alt="" /></a> نمایش داده خواهد شد.'
	),
	array(
		0 => 'اضافه کردن پیوست به پست',
		1 => 'پیوشت ها را میتوانید در هر نقطه از پستتان بیافزایید برای این کار از تگ :<strong>[attachment=][/attachment]</strong> استفاده کنید، اگر مدیر تالار اجازه افزودن پیوست را داده باشد و شما این سطح دسترسی را داشته باشید،میتوانید به پستتان پیوستی بیافزایید. در پستتان منوی کشویی ایجاد میشود که پیوست درون آن قرار میگیرد.'
	),
	array(
		0 => '--',
		1 => 'موارد دیگر'
	...
	array(
		0 => 'آیا میتوانم تگ های دیگری را استفاده کنم ؟',
		1 => 'اگر مدیر این تالار باشید و سطح دسترسی مورد نظر را داشته باشید میتوانید تگهای دیگری را بیافزایید.'
	)
);
