...
$lang = array_merge($lang, array(
	'ADMIN_SIG_PREVIEW'		=> 'آزمایش امضا',
	'AT_LEAST_ONE_FOUNDER'	=> 'نمی توانید صاحب امتیاز سایت را تغییر دهید،باید حداقل یک صاحب امتیاز برای سایت تعریف شود برای لغو امتیاز کاربری باید ابتدا رتبه وی را تنزیل کنید و سپس صاحب امتیاز جدیدی را معرفی کنید.',
	...
	'CANNOT_BAN_ANONYMOUS'			=> 'نمی توانید اکانت های بی نام را تحریم کنید،می توانید سطوح دسترسی کاربران بی نام را از منوی مربوطه ویرایش کنید. ',
	'CANNOT_BAN_FOUNDER'			=> 'نمی توانید اکانت های صاحبان امتیاز سایت را تحریم کنید.',
	'CANNOT_BAN_YOURSELF'			=> 'نمی توانید خودتان را تحریم کنید.',
	'CANNOT_DEACTIVATE_BOT'			=> 'نمی توانید اکانت روبات ها را غیرفعال کنید،لطفا برای این کار به صفحه مربوطه روبات ها مراجعه کنید.',
	...
	'DELETE_USER_EXPLAIN'	=> 'لطفا توجه داشته باشید که حذف کاربر غیرقابل برگشت می باشد. پیغام های خصوصی خوانده نشده ای که توسط این کاربر ارسال شده باشند قابل دسترس گیرنده پیغام نخواهند بود.',
	...
	'USER_NO_ATTACHMENTS'			=> 'فایل پیوستی برای نمایش وجود ندارد.',	'USER_NO_POSTS_TO_DELETE'			=> 'این کاربر پستی برای حذف ویا باقی گذاشتن ندارد.',		
