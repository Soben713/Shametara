...
$lang = array_merge($lang, array(
	'ACP_PRUNE_USERS_EXPLAIN'	=> 'این بخش به شما کمک می کند تا کاربران حذف و یا غیرفعال کنید. اکانت ها می توانند بر اساس معیار های تعداد پست،مقدار فعالیت و ... دسته بندی شوند. می توایند با تایین کردن شاخص هایی اقدام به هرس کاربران کنید مثلا می توانید تایین کنید که کاربران کمتر از 10 پست به طور خودکار هرس شوند و یا کاربرانی که از یک تاریخ مشخص غیرفعال بوده اند،در نتیجه هرس خودکار از سایت حذف شوند.می توانید به طور دستی و عدم تایین شاخص ها لیستی از کاربرانی را که می خواهید هرس شوند،تهیه کنید.',
