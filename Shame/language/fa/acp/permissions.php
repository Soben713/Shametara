...
$lang = array_merge($lang, array(
	...
	'ACL_NEVER'				=> 'هرگز',
	'ACL_SET'				=> 'تنظیم سطوح دسترسی',
	'ACL_SET_EXPLAIN'		=> 'سطوح دسترسی براساس سیستم ساده ی <samp>بله</samp>/<samp>نه</samp> کار می کنند. تنظیم <samp>هرگز</samp> برای کاربری و یا گروه کاربری تمام داده های اعمال شده را تغییر خواهد داد. اگر نمی خواهید داده ای را در گزینه ای برای کاربر اعمال نکنید، <samp>نه</samp>را انتخاب کنید. اگر داده ها در این بخش مشخص نشوند از داده های موجود در بخش ترجیحات استفاده خواهد  شد. در غیر این صورت هم <samp>هرگز</samp> مشخص نخواهد شد. در تمام مواردی که با تیک مشخص شده اند،سطوح دسترسی از آنها کپی خواهد شد.',
	'ACL_SETTING'			=> 'تنیمات',

	'ACL_TYPE_A_'			=> 'سطوح دسترسی مدیریت',
	'ACL_TYPE_F_'			=> 'سطوح دسترسی انجمن',
	'ACL_TYPE_M_'			=> 'سطوح دسترسی مدیران انجمن ها',
	'ACL_TYPE_U_'			=> 'سطوح دسترسی کاربران ش',

	'ACL_TYPE_GLOBAL_A_'	=> 'سطوح دسترسی مدیریت',
	'ACL_TYPE_GLOBAL_U_'	=> 'سطوح دسترسی کاربران',
	'ACL_TYPE_GLOBAL_M_'	=> 'سطوح دسترسی مدیران انجمن ها',
	'ACL_TYPE_LOCAL_M_'		=> 'سطوح دسترسی مدیر انجمن',
	'ACL_TYPE_LOCAL_F_'		=> 'سطوح دسترسی انجمن',

	'ACL_NO'				=> 'نه',
	'ACL_VIEW'				=> 'مشاهده سطوح دسترسی',
	'ACL_VIEW_EXPLAIN'		=> 'در این بخش می توانید سطوح دسترسی مؤثر موجود برای کاربران و گروه ها را ببینید. مربع قرمز نشانگر آن است که آن گروه/کاربر سطوح دسترسی مشخص شده را ندارد و همچنین مربع سبز نشانگر وجود سطوح دسترسی مشخص شده برای کاربر/گروه است.',
	'ACL_YES'				=> 'بله',

	'ACP_ADMINISTRATORS_EXPLAIN'				=> 'در اینجا می توانید سطوح دسترسی مدیریت را برای کاربران/گروه ها مشخص کنید. همه کاربرانی که این سطوح دسترسی را داشته باشند،می توانند به کنترل پنل مدیریت دسترسی پیدا کنند.',
	'ACP_FORUM_MODERATORS_EXPLAIN'				=> 'در اینجا می توانید سطوح دسترسی مدیریت انجمن ها را برای کاربران/گروه ها مشخص کنید. برای مشخص کردن دسترسی کاربران به انجمن ها،مشخص کردن مدیران انجمن ها و مدیران لطفا به صفحه مربوطه مراجعه کنید.',
	...
	'ROLE_FORUM_NEW_MEMBER'		=> 'دسترسی کاربران تازه عضو شده',
	...
	'ROLE_USER_NEW_MEMBER'		=> 'ویژگی های کاربران تاره عضو شده',
