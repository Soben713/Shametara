...
$lang = array_merge($lang, array(
	...
	'tokens'	=>	array(
		...
		'LOCAL_URL'		=> 'محلی URL. URL باید به صورت نسبی به تاپیک مربوط باشد و، ضمنا نمیتوانید از نام سرور یا پروتوکل استفاده کنید مثلا چنین پیشوندی برای تاپیک مناسب نیست â€œ%sâ€‌',
		'RELATIVE_URL'	=> 'نسبی URL. شما میتوانید از این به عنوان قسمتی از URL استفاده کنید., اما توجه داشته باشید: یک URL کامل یک URL نسبی هم هست. هنگامی که تصمیم دارید از URL نسبی استفاده کنید, از LOCAL_URL گرفته شده استفاده کنید.',
...
$lang = array_merge($lang, array(
	'ACP_ICONS_EXPLAIN'		=> 'در این بخش می توانید آیکون های مورد استفاده در موضوعات و پست ها را ویرایش،حذف و اضافه کنید،ای آیکون معمولا در کنار نام موضوعات در لیست موضوعات و عنوان پست در لیست پست های یک موضوع نمایش داده می شوند.اضافه کردن بسته آیکون نیز مقدور می باشد.',
	...
	'ICONS_NONE_ADDED'		=> 'آیکون جدیدی اضافه نشده است',
	'ICONS_ONE_ADDED'		=> 'آیکون با موفقیت اضافه شد.',
	'ICONS_ADDED'			=> 'آیکون ها با موفقیت اضافه شدند.',
	'ICONS_CONFIG'			=> 'پیکربندی آیکون',
	'ICONS_DELETED'			=> 'آیکون با موفقیت حدذف شد.',
	'ICONS_EDIT'			=> 'ویرایش آیکون',
	'ICONS_ONE_EDITED'		=> 'آیکون با موفیت بروزرسانی شد.',
	'ICONS_NONE_EDITED'		=> 'آیکونی بروزرسانی نشد.',
	'ICONS_EDITED'			=> 'آیکون ها با موفقیت بروزرسانی شدند.',
	...
	'SMILIES_NONE_ADDED'		=> 'شکلکی اضافه نشد.',
	'SMILIES_ONE_ADDED'			=> 'شکلک با موفقیت اضافه شد.',
	'SMILIES_ADDED'				=> 'شکلک ها با موفقیت اضافه شدند',
	...
	'SMILIES_NONE_EDITED'		=> 'شکلکی بروزرسانی نشد.',
	'SMILIES_ONE_EDITED'		=> 'شکلک با موفقیت بروزرسانی شد.',
	'SMILIES_EDITED'			=> 'شکلک ها با موفقیت بروزرسانی شدند.',
