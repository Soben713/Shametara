...
<div dir=rtl id="pagecontent">
	...
	<?php $_faq_block_count = (isset($this->_tpldata['faq_block'])) ? sizeof($this->_tpldata['faq_block']) : 0;if ($_faq_block_count) {for ($_faq_block_i = 0; $_faq_block_i < $_faq_block_count; ++$_faq_block_i){$_faq_block_val = &$this->_tpldata['faq_block'][$_faq_block_i]; ?>
		...
		<table dir=rtl class="tablebg" width="100%" cellspacing="1">
		<tr> 
			<td dir=rtl class="cat" align="center"><h4><?php echo $_faq_block_val['BLOCK_TITLE']; ?></h4></td>
		</tr>
		<?php $_faq_row_count = (isset($_faq_block_val['faq_row'])) ? sizeof($_faq_block_val['faq_row']) : 0;if ($_faq_row_count) {for ($_faq_row_i = 0; $_faq_row_i < $_faq_row_count; ++$_faq_row_i){$_faq_row_val = &$_faq_block_val['faq_row'][$_faq_row_i]; ?> 
		<tr>
			<?php if (!($_faq_row_val['S_ROW_COUNT'] & 1)  ) {  ?>

				<td dir=rtl class="row1" valign="top">
			<?php } else { ?>

				<td dir=rtl class="row2" valign="top">
			<?php } ?>

				<div dir=rtl class="postbody"><a name="f<?php echo $_faq_block_val['S_ROW_COUNT']; echo $_faq_row_val['S_ROW_COUNT']; ?>"></a><b>&#187; <?php echo $_faq_row_val['FAQ_QUESTION']; ?></b></div>
				<div dir=rtl class="postbody"><?php echo $_faq_row_val['FAQ_ANSWER']; ?></div>
		...
		<tr>
			<td dir=rtl class="spacer" height="1"><img src="images/spacer.gif" alt="" width="1" height="1" /></td>
		</tr>
		<?php }} ?>
