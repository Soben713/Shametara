<?php if (!defined('IN_PHPBB')) exit; $this->_tpl_include('overall_header.html'); if ($this->_rootref['S_FORUM_RULES']) {  ?>
	<div class="forumrules">
		<?php if ($this->_rootref['U_FORUM_RULES']) {  ?>
			<h3 style="color:red"><?php echo ((isset($this->_rootref['L_FORUM_RULES'])) ? $this->_rootref['L_FORUM_RULES'] : ((isset($user->lang['FORUM_RULES'])) ? $user->lang['FORUM_RULES'] : '{ FORUM_RULES }')); ?></h3><br />
	...
	<br clear="all" />
<?php } if ($this->_rootref['S_DISPLAY_ACTIVE']) {  if (! $this->_rootref['S_DISPLAY_ACTIVE'] && ( $this->_rootref['S_IS_POSTABLE'] || sizeof($this->_tpldata['topicrow']) )) {  ?>
...
<?php if ($this->_rootref['S_NO_READ_ACCESS']) {  ?>
	...
	<br clear="all" />
<?php } } if ($this->_rootref['S_IS_POSTABLE'] || $this->_rootref['TOTAL_TOPICS']) {  ?>
		<table width="100%" cellspacing="1">
		<tr>
			<?php if ($this->_rootref['S_IS_POSTABLE'] && ! $this->_rootref['S_IS_BOT']) {  ?>
	...
	<?php } if ($this->_rootref['S_IS_POSTABLE']) {  ?>
		...
		<tr>
			...
			<td class="nav" nowrap="nowrap">&nbsp;<?php echo (isset($this->_rootref['PAGE_NUMBER'])) ? $this->_rootref['PAGE_NUMBER'] : ''; ?></td>
			<td class="gensmall" nowrap="nowrap">&nbsp;[ <?php echo (isset($this->_rootref['TOTAL_TOPICS'])) ? $this->_rootref['TOTAL_TOPICS'] : ''; ?> ]</td>
			<td class="nav" width="100%" align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>" nowrap="nowrap"><?php $this->_tpl_include('pagination.html'); ?></td>
		</tr>
		</table>
...
<?php } if ($this->_rootref['S_IS_POSTABLE']) {  ?>
	...
	<tr>
		...
		<td align="right"><span class="gensmall"><?php $_rules_count = (isset($this->_tpldata['rules'])) ? sizeof($this->_tpldata['rules']) : 0;if ($_rules_count) {for ($_rules_i = 0; $_rules_i < $_rules_count; ++$_rules_i){$_rules_val = &$this->_tpldata['rules'][$_rules_i]; echo $_rules_val['RULE']; ?><br /><?php }} ?></span></td>
	</tr>
	</table>
<?php } ?>
