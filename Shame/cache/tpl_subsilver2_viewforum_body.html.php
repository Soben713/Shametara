		...
		<tr>
			<td class="cat" colspan="<?php if ($this->_rootref['S_TOPIC_ICONS']) {  ?>7<?php } else { ?>6<?php } ?>">
				...
				<tr class="nav">
					...
					<td align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>" valign="middle"><?php if (! $this->_rootref['S_IS_BOT'] && $this->_rootref['U_MARK_TOPICS'] && sizeof($this->_tpldata['topicrow'])) {  ?><a href="<?php echo (isset($this->_rootref['U_MARK_TOPICS'])) ? $this->_rootref['U_MARK_TOPICS'] : ''; ?>"><?php echo ((isset($this->_rootref['L_MARK_TOPICS_READ'])) ? $this->_rootref['L_MARK_TOPICS_READ'] : ((isset($user->lang['MARK_TOPICS_READ'])) ? $user->lang['MARK_TOPICS_READ'] : '{ MARK_TOPICS_READ }')); ?></a><?php } ?>&nbsp;</td>
				</tr>
				</table>
			</td>
		</tr>
