...
<table dir=rtl dir=rtl width="100%" cellspacing="0" cellpadding="0" border="0">
<tr>
	<td dir=rtl dir=rtl width="20%" valign="top">

<?php if ($this->_rootref['S_SHOW_PM_BOX'] && $this->_rootref['S_POST_ACTION']) {  ?>

	<table dir=rtl dir=rtl class="tablebg" width="100%" cellspacing="1">
	<tr>
	...
	<tr>
		<td dir=rtl dir=rtl class="row1"><b class="genmed"><?php echo ((isset($this->_rootref['L_USERNAME'])) ? $this->_rootref['L_USERNAME'] : ((isset($user->lang['USERNAME'])) ? $user->lang['USERNAME'] : '{ USERNAME }')); ?>:</b><br />[ <a href="<?php echo (isset($this->_rootref['U_FIND_USERNAME'])) ? $this->_rootref['U_FIND_USERNAME'] : ''; ?>" onclick="find_username(this.href); return false;"><?php echo ((isset($this->_rootref['L_FIND_USERNAME'])) ? $this->_rootref['L_FIND_USERNAME'] : ((isset($user->lang['FIND_USERNAME'])) ? $user->lang['FIND_USERNAME'] : '{ FIND_USERNAME }')); ?></a> ]</td>
	</tr>
	
	<tr>
		<td dir=rtl dir=rtl class="row2"><input class="post" type="text" name="username_list" size="20" value="" />&nbsp;<input class="post" type="submit" name="add_to" value="<?php echo ((isset($this->_rootref['L_ADD'])) ? $this->_rootref['L_ADD'] : ((isset($user->lang['ADD'])) ? $user->lang['ADD'] : '{ ADD }')); ?>" /></td>
	</tr>
	<?php } else { ?>

		<tr>
			<td dir=rtl dir=rtl class="row1"><b class="genmed"><?php echo ((isset($this->_rootref['L_USERNAMES'])) ? $this->_rootref['L_USERNAMES'] : ((isset($user->lang['USERNAMES'])) ? $user->lang['USERNAMES'] : '{ USERNAMES }')); ?>:</b></td>
		</tr>
		<tr>
			<td dir=rtl dir=rtl class="row2"><textarea name="username_list" rows="5" cols="22"></textarea><br />
	...
	<?php } if ($this->_rootref['S_GROUP_OPTIONS']) {  ?>
		...
		<tr>
			<td dir=rtl dir=rtl class="row1"><b class="genmed"><?php echo ((isset($this->_rootref['L_USERGROUPS'])) ? $this->_rootref['L_USERGROUPS'] : ((isset($user->lang['USERGROUPS'])) ? $user->lang['USERGROUPS'] : '{ USERGROUPS }')); ?>:</b></td>
		</tr>
		<tr>
			<td dir=rtl dir=rtl class="row2"><select name="group_list[]" multiple="true" size="5" style="width:150px"><?php echo (isset($this->_rootref['S_GROUP_OPTIONS'])) ? $this->_rootref['S_GROUP_OPTIONS'] : ''; ?></select></td>
		</tr>
	<?php } if ($this->_rootref['S_ALLOW_MASS_PM']) {  ?>

		<tr>
			<td dir=rtl dir=rtl class="row1"><div dir=rtl dir=rtl style="float: <?php echo (isset($this->_rootref['S_CONTENT_FLOW_BEGIN'])) ? $this->_rootref['S_CONTENT_FLOW_BEGIN'] : ''; ?>;">&nbsp;<input class="post" type="submit" name="add_bcc" value="<?php echo ((isset($this->_rootref['L_ADD_BCC'])) ? $this->_rootref['L_ADD_BCC'] : ((isset($user->lang['ADD_BCC'])) ? $user->lang['ADD_BCC'] : '{ ADD_BCC }')); ?>" />&nbsp;</div><div dir=rtl dir=rtl style="float: <?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>;">&nbsp;<input class="post" type="submit" name="add_to" value="<?php echo ((isset($this->_rootref['L_ADD_TO'])) ? $this->_rootref['L_ADD_TO'] : ((isset($user->lang['ADD_TO'])) ? $user->lang['ADD_TO'] : '{ ADD_TO }')); ?>" />&nbsp;</div></td>
		</tr>
	<?php } ?>

	</table>
	<div dir=rtl dir=rtl style="padding: 2px;"></div>
<?php } ?>
...
<?php $_l_block1_count = (isset($this->_tpldata['l_block1'])) ? sizeof($this->_tpldata['l_block1']) : 0;if ($_l_block1_count) {for ($_l_block1_i = 0; $_l_block1_i < $_l_block1_count; ++$_l_block1_i){$_l_block1_val = &$this->_tpldata['l_block1'][$_l_block1_i]; ?>
	...
	<tr>
		<?php if ($_l_block1_val['S_SELECTED']) {  ?>
			...
			<td dir=rtl dir=rtl class="row1"><b class="nav"><?php echo $_l_block1_val['L_TITLE']; ?></b>
		...
		<?php } else { ?>
			...
			<td dir=rtl dir=rtl class="row2" nowrap="nowrap" onmouseover="this.className='row1'" onmouseout="this.className='row2'" onclick="location.href=this.firstChild.href;"><a class="nav" href="<?php echo $_l_block1_val['U_TITLE']; ?>"><?php echo $_l_block1_val['L_TITLE']; ?></a>
		<?php } ?>
...
<?php if ($this->_rootref['S_SHOW_COLOUR_LEGEND']) {  ?>
	...
	<table dir=rtl dir=rtl class="tablebg" width="100%" cellspacing="1" cellpadding="0">
	<tr>
	...
	<?php $_pm_colour_info_count = (isset($this->_tpldata['pm_colour_info'])) ? sizeof($this->_tpldata['pm_colour_info']) : 0;if ($_pm_colour_info_count) {for ($_pm_colour_info_i = 0; $_pm_colour_info_i < $_pm_colour_info_count; ++$_pm_colour_info_i){$_pm_colour_info_val = &$this->_tpldata['pm_colour_info'][$_pm_colour_info_i]; ?>
		...
		<tr>
			<?php if (! $_pm_colour_info_val['IMG']) {  ?>
				...
				<td dir=rtl dir=rtl class="row1 <?php echo $_pm_colour_info_val['CLASS']; ?>" width="5"><img src="images/spacer.gif" width="5" alt="<?php echo $_pm_colour_info_val['LANG']; ?>" /></td>
			<?php } else { ?>

				<td dir=rtl dir=rtl class="row1" width="25" align="center"><?php echo $_pm_colour_info_val['IMG']; ?></td>
			<?php } ?>

			<td dir=rtl dir=rtl class="row1"><span class="genmed"><?php echo $_pm_colour_info_val['LANG']; ?></span></td>
		</tr>
	<?php }} ?>
...
<?php } if ($this->_rootref['S_ZEBRA_ENABLED'] && $this->_rootref['S_ZEBRA_FRIENDS_ENABLED']) {  ?>
	...
	<tr>
		<td dir=rtl dir=rtl class="row1" align="center">
...
<td dir=rtl dir=rtl><img src="images/spacer.gif" width="4" alt="" /></td>
<td dir=rtl dir=rtl width="80%" valign="top"><?php if (! $this->_rootref['S_PRIVMSGS'] || $this->_rootref['S_SHOW_DRAFTS']) {  ?><form name="ucp" id="ucp" method="post" action="<?php echo (isset($this->_rootref['S_UCP_ACTION'])) ? $this->_rootref['S_UCP_ACTION'] : ''; ?>"<?php echo (isset($this->_rootref['S_FORM_ENCTYPE'])) ? $this->_rootref['S_FORM_ENCTYPE'] : ''; ?>><?php } ?>