...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="<?php echo (isset($this->_rootref['S_USER_LANG'])) ? $this->_rootref['S_USER_LANG'] : ''; ?>" xml:lang="<?php echo (isset($this->_rootref['S_USER_LANG'])) ? $this->_rootref['S_USER_LANG'] : ''; ?>">
<head>
...
<div dir=rtl id="wrapheader">

	<div dir=rtl id="logodesc">
		<table dir=rtl width="100%" cellspacing="0">
		<tr>
			<td dir=rtl></td>
		</tr>
		</table>
	...
	<div dir=rtl id="menubar">
		<table dir=rtl width="100%" cellspacing="0">
		<tr>
			<td dir=rtl class="genmed" align="center">
	...
	<div dir=rtl id="datebar">
		<table dir=rtl width="100%" cellspacing="0">
		<tr>
            <td dir=rtl class="genmed"></td>
            <td dir=rtl class="genmed" align="right">
	...
	<div dir=rtl id="findbar">
		<table dir=rtl width="100%" cellspacing="0">
		<tr>
			<td dir=rtl class="gensmall"><br /><br /><?php echo (isset($this->_rootref['LAST_VISIT_DATE'])) ? $this->_rootref['LAST_VISIT_DATE'] : ''; ?><br /><?php echo (isset($this->_rootref['CURRENT_TIME'])) ? $this->_rootref['CURRENT_TIME'] : ''; ?></td>
            <td dir=rtl class="gensmall" align="right"><?php if ($this->_rootref['S_DISPLAY_SEARCH']) {  ?>
                ...
                <a href="<?php echo (isset($this->_rootref['U_SEARCH_ACTIVE_TOPICS'])) ? $this->_rootref['U_SEARCH_ACTIVE_TOPICS'] : ''; ?>"><?php echo ((isset($this->_rootref['L_SEARCH_ACTIVE_TOPICS'])) ? $this->_rootref['L_SEARCH_ACTIVE_TOPICS'] : ((isset($user->lang['SEARCH_ACTIVE_TOPICS'])) ? $user->lang['SEARCH_ACTIVE_TOPICS'] : '{ SEARCH_ACTIVE_TOPICS }')); ?></a><br />
                <?php if ($this->_rootref['S_USER_LOGGED_IN']) {  ?><a href="<?php echo (isset($this->_rootref['U_SEARCH_NEW'])) ? $this->_rootref['U_SEARCH_NEW'] : ''; ?>"><?php echo ((isset($this->_rootref['L_SEARCH_NEW'])) ? $this->_rootref['L_SEARCH_NEW'] : ((isset($user->lang['SEARCH_NEW'])) ? $user->lang['SEARCH_NEW'] : '{ SEARCH_NEW }')); ?></a><br />
